...
```shell
#use '--nextseq-trim=20' for data generated by the NextSeq. For read1 which contains mRNA conding information, I kept at least 22nt given the downstream reads mapping. For read2, the first 8 nts are UMI and the following 6 nts are barcodes. FastQC is not necessary.
